...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	*/
	...
	init( AUDIT_SCHEDULE_PERIOD_CHECK_INTERVAL_SEC,              300 ); if ( isSimulated ) AUDIT_SCHEDULE_PERIOD_CHECK_INTERVAL_SEC = deterministicRandom()->randomInt(1, AUDIT_SCHEDULE_PERIOD_CHECK_INTERVAL_SEC+1);
